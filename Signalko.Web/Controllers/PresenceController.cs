...
public class PresenceController : ControllerBase
{
    ...
    // ── GET /api/presence/current — kdo je zdaj znotraj (samo Admin) ─────────
    ...
    // ── GET /api/presence/log — vsi eventi (Admin), paginirani ───────────────
    [HttpGet("log"), Authorize]
    public async Task<IActionResult> Log(
        [FromQuery] int?      userId   = null,
        [FromQuery] string?   search   = null,   // iskanje po imenu / priimku
        [FromQuery] string?   cardId   = null,   // iskanje po CardID
        [FromQuery] string?   type     = null,   // IN / OUT
    ...
    // ── GET /api/presence/me — lastni eventi prijavljenega userja ─────────────
    ...
    // ── GET /api/presence/user/{id} — eventi za konkretnega userja (Admin) ───
